...
```powershell
$repo="ymc-github/i_edit_json";$repo_desc="A lightweight, high-performance tool for editing JSON based on field paths";
...
# gh repo  delete "ymc-github/toml_path" --yes
```
